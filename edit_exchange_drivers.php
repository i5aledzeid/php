        ...
        <form action="" method="post" style="width: 80vw; min-width: 350px;">
          ...
          <div class="row">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" name="car_number" value="<?php echo $row['car_number'] ?>" placeholder="Car Number" required>
            </div>
            <div class="col">
